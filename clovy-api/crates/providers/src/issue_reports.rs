...
use clovy_config::IssueReportsConfig;
use clovy_domain::{DomainError, IssueReport, IssueReportDelivery, IssueReportSink};
...
mod issue_title_tests {
    ...
    use clovy_domain::{IssueReport, UserId};
    ...
    fn issue_entries_split_multi_issue_agent_diagnosis() {
        ...
        let entries = issue_create_entries(&report, "Clovy");
...
mod os_platform_tests {
    ...
    fn report() -> IssueReport {
        IssueReport {
            ...
            attachments: vec![clovy_domain::IssueReportAttachment {
    ...
    fn sink_with_config(config: &IssueReportsConfig) -> OsPlatformIssueReportSink {
        OsPlatformIssueReportSink::from_config(reqwest::Client::new(), config, "Clovy")
    ...
    fn os_platform_sink_uses_default_clovy_bug_reports_destination_with_api_key() {
        ...
        let sink = OsPlatformIssueReportSink::from_config(reqwest::Client::new(), &config, "Clovy")
    ...
    fn report_with_two_videos() -> IssueReport {
        ...
        report.attachments = vec![
            clovy_domain::IssueReportAttachment {
