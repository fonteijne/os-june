...
// benchmarked against that budget. Off hides the sidebar entry, the command
// palette action, and the settings tab; the native side never spawns the
// helper or registers the hotkey. Keep in lockstep with the Rust
// DICTATION_ENABLED in src-tauri/src/feature_flags.rs.
