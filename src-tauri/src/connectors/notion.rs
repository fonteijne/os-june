...
// The branded loopback success page is shared across connectors; see
// connectors/oauth.rs for the markup and the token-baking rationale.
use super::oauth::SUCCESS_BODY;
