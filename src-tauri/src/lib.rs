...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent_runtime::api::stage_agent_attachment_bytes,
            agent_runtime::api::discard_staged_agent_attachments,
            agent_runtime::api::prune_staged_agent_attachments,
            ...
            providers::save_local_transcription_settings,
            providers::set_local_transcription_enabled,
            providers::probe_local_transcription_endpoint,
